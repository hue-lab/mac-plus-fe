...
export default function DescThree(props) {
  ...
  if (product.variants.length > 0) {
    ...
    if (product.variants[0].color) {
      product.variants.forEach((item) => {
        if (colors.findIndex((color) => color.name === item.color.name) === -1) colors.push({ name: item.color.name, value: item.color.color });
      });
    }
  }
        ...
        <TabPanel className="tab-pane product-tab-description">
          <div className="row">
            <div className="col-12 mb-8">
              <p className="mb-6">Praesent id enim sit amet.Tdio vulputate eleifend in in tortor. ellus massa. siti iMassa ristique sit amet condim vel, facilisis quimequistiqutiqu amet condim Dilisis Facilisis quis sapien. Praesent id enim sit amet.</p>
              <ul className="mb-6">
        ...
        {isGuide ? (
          <TabPanel className="tab-pane product-tab-size-guide">
            <figure className="size-image mt-4 mb-4">
              <img src="./images/size_guide.png" alt="Size Guide Image" title="Size Guide Image" width="217" height="398" />
            </figure>
        ...
        <TabPanel className="tab-pane product-tab-reviews">
                ...
                <li>
                  <div className="comment">
                    <figure className="comment-media">
                      <ALink href="#">
                        <img src="./images/blog/comments/1.jpg" alt="avatar" title="avatar" width="60" height="60" />
                      </ALink>
                    </figure>
                ...
                {product.reviews > 1 ? (
                  <li>
                    <div className="comment">
                      <figure className="comment-media">
                        <ALink href="#">
                          <img src="./images/blog/comments/2.jpg" alt="avatar" title="avatar" width="60" height="60" />
                        </ALink>
                      </figure>
          ...
          <div className="reply">
            <div className="title-wrapper text-left">
              <h3 className="title title-simple text-left text-normal">{product.reviews > 0 ? 'Add a Review' : 'Be The First To Review “' + product.name + '”'}</h3>
            ...
            <div className="rating-form">
              ...
              <span className="rating-stars selected">
                {[1, 2, 3, 4, 5].map((num, index) => (
                  <a className={`star-${num}`} href="#" onClick={setRating} key={'star-' + index}>
                    {num}
                  </a>
                ))}
              </span>
