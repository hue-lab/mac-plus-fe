          ...
          loading ? <div className="widget-2"></div> :
            <div className="sticky-sidebar">
                  ...
                  deliveryMethods.map(method => (
                    <div className="icon-box icon-box-side icon-box3" key={method._id}>
                      ...
                      <div className="icon-box-content">
                        <h4 className="icon-box-title text-capitalize">{method.name}</h4>
              ...
              <div className="widget widget-products widget-collapsible">
                <h4 className="widget-title mb-3 lh-1 text-capitalize ">Похожие товары</h4>
                ...
                <ul className="widget-body mb-0">
                  <OwlCarousel adClass="owl-nav-top" options={mainSlider7}>
                    ...
                    {featured.length > 3 ? <div className="products-col_gap">
                      {
