...
function AboutUs() {
  ...
  return (
    <main className="main about-us">
      ...
      <div className="page-header pl-4 pr-4" style={{ backgroundImage: `url( ./images/page-header/about-us.jpg )`, backgroundColor: '#3C63A4' }}>
            ...
            <div className="container">
              <div className="row align-items-center">
                <div className="col-md-7 mb-4">
                  <figure>
                    <LazyLoadImage src="./images/subpages/customer.jpg" alt="Happy Customer" title="Happy Customer" width="580" height="507" effect="opacity" className="banner-radius" style={{ backgroundColor: '#BDD0DE' }} />
                  </figure>
                </div>
                <div className="col-md-5 mb-4">
                  ...
                  <ALink href="#" className="btn btn-dark btn-link btn-underline ls-m">
            ...
            <div className="container">
              <div className="row align-items-center">
                ...
                <div className="col-md-6 mb-4">
                  <figure>
                    <LazyLoadImage src="./images/subpages/store.jpg" alt="Our Store" title="Our Store" width="580" height="507" effect="opacity" className="banner-radius" style={{ backgroundColor: '#DEE6E8' }} />
                  </figure>
                </div>
              </div>
            </div>
            ...
            <div className="container mt-8 mb-10">
              ...
              <OwlCarousel adClass="owl-theme" options={mainSlider16}>
                <figure className="brand-wrap bg-white banner-radius">
                  <img src="./images/brands/1.png" alt="Brand" title="Brand" width="180" height="100" />
                </figure>
                <figure className="brand-wrap bg-white banner-radius">
                  <img src="./images/brands/2.png" alt="Brand" title="Brand" width="180" height="100" />
                </figure>
                <figure className="brand-wrap bg-white banner-radius">
                  <img src="./images/brands/3.png" alt="Brand" title="Brand" width="180" height="100" />
                </figure>
                <figure className="brand-wrap bg-white banner-radius">
                  <img src="./images/brands/4.png" alt="Brand" title="Brand" width="180" height="100" />
                </figure>
                <figure className="brand-wrap bg-white banner-radius">
                  <img src="./images/brands/5.png" alt="Brand" title="Brand" width="180" height="100" />
                </figure>
                <figure className="brand-wrap bg-white banner-radius">
                  <img src="./images/brands/6.png" alt="Brand" title="Brand" width="180" height="100" />
                </figure>
              </OwlCarousel>
            </div>
          </section>
            ...
            <div className="container">
              ...
              <div className="row cols-sm-2 cols-md-4">
                <Reveal keyframes={fadeInLeftShorter} delay="20" duration="1000" triggerOnce>
                  <div className="member">
                    <figure className="banner-radius">
                      <LazyLoadImage src="./images/subpages/team1.jpg" alt="Oteam member" title="Oteam member" width={280} height={280} effect="opacity" style={{ backgroundColor: '#EEE' }} />
                ...
                <Reveal keyframes={fadeInLeftShorter} delay="30" duration="1000" triggerOnce>
                  <div className="member">
                    <figure className="banner-radius">
                      <LazyLoadImage src="./images/subpages/team2.jpg" alt="Oteam member" title="Oteam member" width={280} height={280} effect="opacity" style={{ backgroundColor: '#EEE' }} />
                ...
                <Reveal keyframes={fadeInLeftShorter} delay="40" duration="1000" triggerOnce>
                  <div className="member">
                    <figure className="banner-radius">
                      <LazyLoadImage src="./images/subpages/team3.jpg" alt="Oteam member" title="Oteam member" width={280} height={280} effect="opacity" style={{ backgroundColor: '#EEE' }} />
                ...
                <Reveal keyframes={fadeInLeftShorter} delay="50" duration="1000" triggerOnce>
                  <div className="member">
                    <figure className="banner-radius">
                      <LazyLoadImage src="./images/subpages/team4.jpg" alt="Oteam member" title="Oteam member" width={280} height={280} effect="opacity" style={{ backgroundColor: '#EEE' }} />
