...
import {getProductById} from "~/utils/endpoints/products";

ProductDefault.getInitialProps = async ({ query }) => {
    const product = query.slug ? await getProductById(query.slug) : null;
    return { product }
}

export default function ProductDefault ({ product }) {
  console.log(product);
