    ...
    typeof window === "undefined" ?
      <Provider store={store}>
        <Helmet>
          ...
          <meta property="og:title" content={pageProps.layoutFields['main-seo-title'] || 'Mac Plus'}/>
          <meta name="keywords" content="React Template"/>
          <meta name="description" content={pageProps.layoutFields['main-seo-description'] || 'Интернет-магазин электроники в Беларуси'}/>
          <meta property="og:description" content={pageProps.layoutFields['main-seo-description'] || 'Интернет-магазин электроники в Беларуси'}/>
...
App.getInitialProps = async ({ Component, ctx }) => {
  ...
  const layoutFields = await getFieldsObject('telegram', 'viber', 'instagram', 'phone', 'email', 'address', 'work_time', 'copyright', 'legal', 'nav-sale-title', 'nav-sale-link', 'nav-sale-image', 'main-seo-title', 'main-seo-description');
  let pageProps = {};
